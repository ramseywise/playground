...
from agents.visualizer.providers import (
...
def test_pollinations_generate_image(tmp_path: Path) -> None:
    ...
    with patch("agents.visualizer.providers.httpx.Client") as mock_client_cls:
        ctx = MagicMock()
...
def test_get_provider_default_pollinations() -> None:
    ...
    with patch("agents.visualizer.providers.settings") as mock_settings:
