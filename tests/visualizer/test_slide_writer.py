...
from agents.visualizer.models import DeckIntake, DeckOutline, SlideContent
from agents.visualizer.slide_writer import SLIDE_SYSTEM, generate_slide_content
...
def test_generate_slide_content_parses_json() -> None:
    ...
    with patch("agents.visualizer.slide_writer.create_client", return_value=mock_client):
