...
from agents.librarian.pipeline.reranker.cross_encoder import CrossEncoderReranker, _sigmoid
...
def cross_encoder_reranker() -> CrossEncoderReranker:
    ...
    with patch(
        "agents.librarian.pipeline.reranker.cross_encoder._load_cross_encoder",
