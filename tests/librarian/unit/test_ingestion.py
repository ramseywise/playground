...
from agents.librarian.rag_core.ingestion.pipeline import IngestionPipeline, IngestionResult, _sha256
...
def pipeline(
    ...
    from agents.librarian.rag_core.ingestion.chunking.strategies import FixedChunker
