...
from agents.librarian.rag_core.eval_harness.tasks.generate_synthetic import (
...
def test_generate_from_chunks_returns_golden_samples() -> None:
    ...
    with (
        patch(
            "agents.librarian.rag_core.eval_harness.tasks.generate_synthetic.CONFIRM_EXPENSIVE_OPS",
            True,
        ),
        patch(
            "agents.librarian.rag_core.eval_harness.tasks.generate_synthetic.anthropic.Anthropic",
