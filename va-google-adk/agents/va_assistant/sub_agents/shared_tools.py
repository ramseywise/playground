"""Shared tools and config included in every VA sub-agent."""

from google.adk.tools import ToolContext
from google.genai import types

# Sub-agents use thinking for tool-use reasoning, then produce structured output.
...
def report_out_of_domain(tool_context: ToolContext) -> str:
    ...
    tool_context.actions.transfer_to_agent = "va_assistant"
    return f"Registered {agent_name} as out-of-domain. Transferring to va_assistant."
