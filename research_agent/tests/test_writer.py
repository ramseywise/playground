...
from research_agent.models import Note, NoteMetadata
from research_agent.writer import render_note, sanitize_filename, write_note
...
def test_write_note_creates_file(tmp_path: Path) -> None:
    import research_agent.writer as writer_module
