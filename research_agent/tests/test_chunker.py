...
def test_hard_split_fallback_when_no_toc() -> None:
    with patch("research_agent.chunker.extract_toc", return_value="No headings here."):
...
def test_toc_detected_chapters() -> None:
    ...
    with patch("research_agent.chunker.extract_toc", return_value=toc_text):
...
def test_plan_chunks_real_pdf() -> None:
    ...
    from research_agent.chunker import plan_chunks
