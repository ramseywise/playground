...
class IngestionPipeline:
    ...
    async def ingest_file(self, path: Path) -> IngestionResult:
        ...
        from agents.librarian.rag_core.ingestion.loaders import load_markdown_file
    ...
    async def ingest_directory(
        ...
        from agents.librarian.rag_core.ingestion.loaders import load_directory
    ...
    async def ingest_s3_object(
        ...
        from agents.librarian.rag_core.ingestion.s3_loader import S3DocumentLoader
