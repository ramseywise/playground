...
from agents.librarian.tools.api.deps import get_settings, init_graph, init_pipeline
from agents.librarian.tools.api.middleware import (
    RequestIDMiddleware,
    RequestLoggingMiddleware,
    TimeoutMiddleware,
)
from agents.librarian.tools.api.routes import router
from agents.librarian.utils.config import LibrarySettings
from agents.librarian.utils.logging import get_logger
from agents.librarian.tools.core.config.logging import configure_logging
...
def main() -> None:
    ...
    settings = get_settings()
    uvicorn.run(
        "agents.librarian.tools.api.app:app",
