...
ALL_TOOLS = {
    ...
    "create_customer", "edit_customer",                             # [WRITE]
    # Invoices
    "get_invoice", "list_invoices", "get_invoice_summary",
    "get_invoice_dso_stats", "get_invoice_lines_summary",
    "create_invoice", "edit_invoice", "void_invoice",               # [WRITE]
    ...
    "create_product", "edit_product",                               # [WRITE]
    # Quotes
    "list_quotes", "get_quote_conversion_stats",
    "create_quote", "edit_quote", "create_invoice_from_quote",      # [WRITE]
    # Emails
    "send_invoice_by_email", "send_quote_by_email",                 # [WRITE]
    # Invitations
    "invite_user",                                                  # [WRITE]
    # Expenses
    "list_expenses", "get_expense", "get_expense_summary",
    "get_vendor_spend", "get_expenses_by_category", "get_gross_margin",
