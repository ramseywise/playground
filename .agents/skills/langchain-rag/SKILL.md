...
| File | Contents |
|------|----------|
| `references/rag-strategies.md` | Chunking, hybrid retrieval, CRAG, reranking, intent routing, LangFuse vs LangSmith — patterns from help-assistant + listen-wiseer |
| `references/advanced-patterns.md` | Self-RAG, Adaptive RAG, HyDE, GraphRAG, A2A, MCP, memory types, Plan-and-Execute, agentic eval |
