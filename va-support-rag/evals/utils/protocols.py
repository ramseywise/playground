...
from evals.utils.models import EvalTask, GraderResult
...
class Grader(Protocol):
    ...
    Implementations include QA graders (exact match, LLM judge, Ragas) and
    retrieval regression (via harness).
    """
