...
Run a full design sprint for: $ARGUMENTS

# Design Sprint Framework

Produce a full set of planning artefacts: problems, pain points, insights, opportunities, HMW statements, technical solutions, workstream clusters, and a dependency-mapped initiative backlog.
...
Group all technical solutions into clusters using these lenses:

**WHO** — end-user or agent facing. Owner: FE Engineers.
...
Rules:
- No initiative should be blocked by another initiative that has not started
...
- Arrows between cards showing dependency direction
...
Output as a card grid grouped by ownership area.
...
- Platform / security / infra foundation is represented if auth, data storage, or external APIs are needed
- If the use case involves multiple markets or languages, multilingual requirements are called out as day-one decisions
