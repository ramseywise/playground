...
## Step 1 — Embedder warm-up on startup `[P0]`
...
## Step 2 — LangGraph persistent checkpointer `[P0]`
...
## Step 3 — Anthropic API retry / backoff `[P0]`
...
## Step 4 — Chroma single-writer guard `[P1]`
...
## Step 5 — Surface escalation signal in API response `[P1]`
...
## Step 6 — Embedding model version pinning `[P2]`
...
## Step 7 — Architecture decision record `[P2]`
