...
**Research:** `.claude/docs/research/ts-copilot-service.md`
**Related plan:** `.claude/docs/plans/py-copilot-service.md` (Python port — architectural decisions cross-affect this plan)
